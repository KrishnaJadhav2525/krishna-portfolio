...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-md sm:max-w-xl px-4">
          ...
          {navLinks.map(({ href, label }) => {
            ...
            return (
              <Link
                ...
                href={href}
                className={cn(
                  "relative px-4 py-2 text-sm font-medium transition-colors duration-200 outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-full",
