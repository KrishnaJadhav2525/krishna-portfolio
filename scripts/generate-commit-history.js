...
function generateHistory() {
    ...
    const datesToProcess = args.length > 0 ? args.map(d => new Date(d)) : [new Date()];

    for (const TODAY of datesToProcess) {
        ...
        console.log(`\nSuccessfully generated ${totalCommits} commits for ${TODAY.toDateString()}!`);
    }
}
